...
```{r TotalStepsHistogram, fig.height=8, fig.width=6}
...
```{r TotalStepsHistogramFilled, fig.height=8, fig.width=6}
...
```{r WeekendvsWeekdayMeanSteps, fig.height=8, fig.width=6}
